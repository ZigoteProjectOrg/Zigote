// Same set the other design packages (Material, Adwaita) pull in, so widget code here reads like
// widget code everywhere else in the repo.
...
global using Zigote.UI.Widgets.Navigation;