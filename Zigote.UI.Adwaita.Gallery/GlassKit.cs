...
///     So this is the over-media variant: a dark scrim keeps white content legible on a bright sky
///     and a black coat alike, and the rim is white in both app themes, because a glass edge
///     catches light, not the theme. The lens itself (refraction, frost, dispersion) is the
///     engine's hardware glass; the gel response (hover lifts, press compresses) matches what
///     <see cref="Glass" /> gives the system controls.
/// </summary>
/// <remarks>
...
internal sealed class LiquidPane : Widget
{
    ...
    /// <summary>Scrim colour; the alpha is the strength (0 = clear lens, 1 = opaque paint).</summary>
    public Color Tint { get; set; } = Color.Rgba(
        r: 0,
        g: 0,
        b: 0,
        a: 0.22f
