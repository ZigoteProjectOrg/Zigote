...
internal static class GalleryPreferences
{
            ...
            Groups = {
                new AdwPreferencesGroup(
                    ...
                    Rows = {
                        new Watch(() => new AdwSwitchRow(
                                ...
                                subtitle: "Track the desktop appearance and accent",
                                value: app.FollowSystem.Value,
                                onChanged: v => app.FollowSystem.Value = v
                            )
                        ),
                        new AdwActionRow(
                            title: "Style",
                            subtitle: "Overrides the system preference"
                        ) {
                            Suffixes = {
                ...
                new AdwPreferencesGroup("Preview") {
                    Rows = {
                        ...
                        new AdwSwitchRow(title: "A switch", value: true),
                        new AdwActionRow("A slider") {
                            Suffixes = { new SizedBox(width: 160f, child: new AdwSlider(0.6f)) },
                        },
                    },
                },
            },
            ...
            Groups = {
                new AdwPreferencesGroup("Windows") {
                    Rows = {
                        new AdwActionRow(
                            title: "New Window",
                            subtitle: "Each window navigates on its own"
                        ) {
                            Suffixes = { new AdwButton(label: "Open", onPressed: app.NewWindow) },
                        },
                    },
                },
                new AdwPreferencesGroup("Feedback") {
                    Rows = {
                        new AdwActionRow(
                            title: "Toasts",
                            subtitle: "Float over the window that raised them"
                        ) {
                            Suffixes = {
                                new AdwButton(
                                    label: "Show",
                                    onPressed: () => toast("Sent from Preferences")
                                ),
                            },
                        },
                    },
    ...
    {
        foreach ((var value, string name) in AccentPicker.Accents)
        {
            if (value == accent)
                return name;
        }
