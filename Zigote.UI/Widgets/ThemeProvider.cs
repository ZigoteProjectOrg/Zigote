...
public sealed class ThemeProvider : InheritedWidget
{
    ...
    /// </summary>
    internal void SetDataSilently(ThemeData data)
    {
        _data = data;
    }
    ...
    {
        return ctx.DependOn<ThemeProvider>()?.Data ?? ThemeData.Dark;
    }

    public override bool UpdateShouldNotify(InheritedWidget oldWidget)
    {
        return oldWidget is not ThemeProvider old || !ReferenceEquals(old.Data, Data);
    }
}
