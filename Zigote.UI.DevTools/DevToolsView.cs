    ...
    : StatefulWidget
{
    ...
    {
        return new DevToolsViewState(controller, chrome);
    }

    private sealed class DevToolsViewState(DevToolsController controller, DevToolsChrome chrome)
        : WidgetState<DevToolsView>
    {
