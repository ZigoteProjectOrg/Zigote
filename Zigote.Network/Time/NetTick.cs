...
/// <summary>
///     Fixed-timestep accumulator. Feed it the variable frame delta; it returns how many fixed steps
///     to run
///     this frame so the simulation advances at a constant rate regardless of frame rate.
///     <see cref="Alpha" />
///     is the leftover fraction for rendering between steps. Guarded against the spiral of death (a
///     long stall
...
public sealed class NetTick(float interval)
{
    ...
    /// <summary>
    ///     Fraction in [0,1) through the current step — use to interpolate rendering between fixed
    ///     states.
    /// </summary>
