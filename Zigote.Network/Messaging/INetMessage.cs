...
///     <see cref="INetSerializable.Deserialize" /> and give the type a parameterless constructor so
///     the
///     receiver can instantiate it. Register handlers with <see cref="NetworkManager.OnMessage{T}" />
///     and
