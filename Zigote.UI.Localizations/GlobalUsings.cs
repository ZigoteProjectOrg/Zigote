// Ambient imports for the localization module. The pure-logic types (Locale, MessageFormat,
// PluralRules, catalogs) depend only on the BCL; the widget/provider types reach into Zigote.UI.
